        ...
        <div className="container mx-auto">
          <div className="lg:flex justify-between bg-white py-10">
            <div className="lg:w-1/2 w-full bg-[#F4F4FF] py-10 pl-5 rounded-lg">
              ...
              <button className="lg:px-10 px-5 lg:mt-5 lg:py-3 py-2 lg:w-[600px] w-[300px] text-white font-sans lg:text-[18px] text-[16px] rounded-full border-2 bg-red-400 mx-auto">
                Set Free Quotes
              </button>
            </div>
            <div className="lg:w-1/2 w-full bg-blue-600 py-10 px-8 rounded-lg">
